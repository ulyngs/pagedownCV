...
output:
  pagedown::html_paged:
    ...
    css: [ul_style.css, default-page.css, "https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap-grid.min.css", "https://use.fontawesome.com/releases/v5.7.2/css/all.css"]
