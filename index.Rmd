...
This repository has three different versions of my resume, with the paged versions created with [`pagedown`](https://github.com/rstudio/pagedown) (NOTE: 1 and 2 does *not* work in the Safari browser):
