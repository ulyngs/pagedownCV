...
This repository has three different versions of my resume (NOTE: 1 and 2 does *not* work in the Safari browser):
...
The paged resumés are made with [`pagedown`](https://github.com/rstudio/pagedown).
