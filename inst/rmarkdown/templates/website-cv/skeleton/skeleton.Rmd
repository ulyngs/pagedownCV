...
# this example uses the tibble 'cv_entries' which contains sample content from my own CV that is automatically loaded when you library(pagedownCV)
...
# save_gsheet_as_csv("cv_entries", gsheet_url = "https://docs.google.com/spreadsheets/d/1ta71CAGkcLqm-W1UdVRA_JJSddWV2TsrRZsCnQlmOis/edit?usp=sharing")
