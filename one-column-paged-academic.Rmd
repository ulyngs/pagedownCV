...
I am passionate about creating impact through rigorous open science and action research.
:::
...
<div class="grid-container-publications"> 
...
<h3>In computer science, top-tier conference (<30% acceptance rate) are as, or more impactful than journals, see http://doi.org/fgjt2h</h3>
</div>
</div>
```{r}
