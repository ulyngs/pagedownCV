...
output:
  html_document:
    css: [make-cv-like-other.css, one-column-cv.css, "website-page.css", "style.css", "academicons-1.8-2.6/css/academicons.min.css", "fontawesome-free-5.8.1-web/css/all.min.css"]
    toc: true
    toc_float: true
