...
I am a computer scientist, cognitive psychologist, and musician. I am passionate about applying insights from the behavioural neurosciences to design digital technology that is sensitive to human limitations and biases, particularly in relation to attention and self-regulation.
...
| <i class="fas fa-globe"></i> | ulriklyngs.com |
| <i class="fab fa-github"></i> | ulyngs |
...
publications %>%
  ...
  mutate(citation = str_replace(citation, "Lyngs, U.", "**Lyngs, U.**")) %>%  # make my name bold
  select(citation) %>% 
  knitr::kable()
