...
output:
  ...
  pagedown::html_paged:
    ...
    css: [one-column-paged.css,  "fontawesome-free-5.8.1-web/css/all.css"]
    number_sections: false
links-to-footnotes: true #set to false when not paged output
params:
  include_all: true #set to false for short 2-column version
  paged_output: false #set to false when not paged output
---
